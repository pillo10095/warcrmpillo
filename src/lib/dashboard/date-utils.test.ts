...
describe("mondayIndex", () => {
  it("maps Monday → 0 and Sunday → 6", () => {
    // Build dates in LOCAL time: an ISO date-only string ("2026-05-18")
    // is parsed as UTC midnight, which shifts back a day in negative-UTC
    // timezones and would make this test timezone-dependent.
